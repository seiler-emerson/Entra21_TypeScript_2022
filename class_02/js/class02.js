...
console.log(animal1.getEspecie);
// ANIMAL 2
let animal2 = new Animal("Hydrochoerus hydrochaeris", "capivara", 15, ["Agua", "Mangue"]);
console.log(animal2);
...
console.log(animal2.getEspecie);
// Aluno
let emerson = new Aluno("Emerson Seiler", 27, [10, 9, 9]);
console.log(emerson);
...
// Professor
let oliota = new Professor("Rubem Oliota", 33, ["Java"], 250, 16);
console.log(oliota);
...
// Vendedor
let vendedor1 = new Vendedor("Carlos Gabriel", 25, 150, 16);
